...
int main(){
	...
	std::cout << "WEIRD_FLOAT : " << clyn1.WIERD_FLOAT << std::endl;
	std::cout << "WEIRD_C_STRING : " << clyn1.WEIRD_C_STRING << std::endl;
	std::cout << "WEIRD_INT_ARRAY[3] : " << clyn1.WEIRD_INT_ARRAY_CONSTANT[3] << std::endl;
