...
{
    std::cout << "Default constructor called for civil engineer called..." << std::endl;
}
...
/*
BAD: The civilEngineer has no business naming fullname, age and address as it's not part of it's
member variable
CivilEngineer::CivilEngineer(std::string_view fullname,int age,
std::string_view address, int contract_count, std::string_view speciality) :
