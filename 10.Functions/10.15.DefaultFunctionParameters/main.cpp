...
void greet_teacher (std::string_view name_sv = "teacher", int homeworks = 12,
     int exams = 4, double pass_rate = 0.5, std::string_view first_dpmt = "Computer Sci");
                     ...
                     int exams, double pass_rate, std::string_view first_dpmt)
{
    ...
    std::cout << "In the past semester, we've had " << homeworks << " homeworks, and " << exams << 
            " exams.\tThe pass rate was around : " << pass_rate << std::endl;
