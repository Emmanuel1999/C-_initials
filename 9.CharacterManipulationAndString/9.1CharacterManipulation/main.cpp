...
int main(){
    ...
    */
    ...
    char message [] {"Hello there. How are you doing? There's money to be made today!"} ;
    ...
    */
    ...
    std::cout << std::endl;
    char thought [] {"This C++ Programming Language is one of the most widely used Languages on the Planet."};
    ...
    */
    ...
    char statement [] {"Opatola Emmanuel is a 500 level student. He's been in FUTA since 2015!"};
    ...
    */
    ...
    char original_str [] {"Home. Where the Heart is!"};
