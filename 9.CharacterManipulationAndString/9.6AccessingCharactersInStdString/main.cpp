...
int main(){
    ...
    */
    ...
    std::cout << "str1 (using range based for loop) : ";
    for(char value : str1) 
    {
        std::cout << " " << value;
    }
    ...
    */
    ...
    std::cout << "The front character in str2 is : " << front_char << std::endl;
    std::cout << "The back character in str2 is : " << back_char << std::endl;
