...
int main(){
    ...
    std::string planet {"Earth. Where everything sucks."}; //Initialize with string literal
    ...
    std::string message {"Hello there", 5}; //Initialize with part of a string literal
                                            //contains Hello
    std::string wierd_message (4,'e'); //Initialize with multiple copies of a char
									 // contains eeee
    ...
    std::cout << "fullname : " << full_name << std::endl;
    std::cout << "planet : " << planet << std::endl;
    std::cout << "prefered planet : " << prefered_planet << std::endl;
    std::cout << "message : " << message << std::endl;
    std::cout << "wierd message : " << wierd_message << std::endl;
    std::cout << "greeting : " << greeting << std::endl;
    std::cout << "saying hello : " << saying_hello << std::endl;

    //Changing std::string at runtime

    planet = "Earth. Where there's too much sun, not enough money and backstabbers everywhere...Argh!";
    std::cout << "planet : " << planet << std::endl;
