...
int main(){
    ...
    std::cout << "str1 capacity is : " << str1.capacity() << std::endl;
    ...
    */
    ...
    std::cout << "str2 : " << str2 << std::endl;//19922
    */
    ...
    */
    ...
    str7.insert(5,str8,27,6);//Hello World!
    str8.insert (28,str7,0,6);//Personal tryouts - Selah --// Statistical Analysis of the Hello World Population
