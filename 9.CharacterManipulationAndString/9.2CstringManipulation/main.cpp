...
int main(){
    ...
    */
    ...
    const char * const str {"Try not. Do or do not. Thou have not tried."};
    //Can make this a const pointer to prevent users from making it point elsewhere
    ...
    */
	...
	//we use std::strchr to find all the characters one by one.
    //It's not advisable to use this method
