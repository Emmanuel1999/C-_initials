...
std::optional<size_t> find_char_v2(const std::string & str, char c)
{
...
//Specify default char to search for

std::optional<size_t> find_char_v3 (const std::string & str, std::optional<char> c = std::nullopt)
{
...
int main(){
    ...
    /*
    std::optional<size_t> result = find_char_v2(str1,c);
    ...
    */
	...
	auto result1 = find_char_v3(str1,'o'); //Will search for 'z' if you don't specify 
