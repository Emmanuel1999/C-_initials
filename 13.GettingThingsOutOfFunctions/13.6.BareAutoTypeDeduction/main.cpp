...
int main(){
	...
	std::cout << "sizeof(x) : " << sizeof(x) << std::endl;//8
	std::cout << "&some_var : " << &some_var << std::endl;//address
	std::cout << "&x : " << &x << std::endl;//diff. address
    std::cout << " some_var : " << some_var << std::endl;//55.5
    std::cout << " x : " << x << std::endl;//55.5
    */
	...
	std::cout << "&y : " << &y << std::endl;  // diff address
	std::cout << "some_var : " << some_var << std::endl; //55.5
