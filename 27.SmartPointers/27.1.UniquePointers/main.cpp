...
int main(){
    ...
    std::cout << std::endl;
    std::cout << "Hitting outside the scope" << std::endl;
...
//-----------------------------------------------------------------------------
    ...
    /*
    {
        Dog* p_dog3 = new Dog("Doupper");
        std::unique_ptr<Dog> up_dog_4{p_dog3}; //Can also manage a previously allocated
                                            //space managed by a raw pointer. You shouldn't
                                            //try to use the raw pointer from this point on.
        std::unique_ptr<Dog> up_dog_5 {new Dog("Dioppy")};
...
//----------------------------------------------------------------------------------
    ...
    std::unique_ptr<Dog> up_dog_7 = std::make_unique<Dog>("Jorumpa");
    up_dog_7->print_dog();
...
//----------------------------------------------------------------------------------
    /*
    //Copies not allowed
    std::unique_ptr<Dog> up_dog_8 = std::make_unique<Dog>("Dunipier");
    up_dog_8->print_dog();
    //Can get the wrapped pointer address : useful for older raw pointer APIs
    std::cout << "Dunipier memory address: " << up_dog_8.get() << std::endl;
