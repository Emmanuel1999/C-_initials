...
int main(){
    ...
    /*
    {
        ...
        Dog dog_array[3] {Dog("DoggyA"), Dog("DoggyB"), Dog("DoggyC")};
    ...
    */
    ...
    //Array located on the heap
    /*
    {
        Dog* p_dog_array_raw = new Dog[3] {Dog("DoggyD"), Dog("DoggyE"), Dog("DoggyF")};
    ...
    */
    ...
    {
        auto arr_ptr = std::unique_ptr<Dog[]> (new Dog[3]{Dog("DoggyG"), Dog("DoggyH"), Dog("DoggyI")});
