...
int main(){
    ...
    //     A single false operand makes everything false
    ...
    //    A single true operand makes everything true; 
    // NB. It's the opposite of the AND operation.
    ...
    //NOT: Simply negates whatever operand is in front of
    std::cout << std::endl;
